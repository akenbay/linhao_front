    ...
    <footer className="relative bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-8 sm:pb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-10 sm:mb-14">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 sm:gap-4">
              {[
                { label: 'Telegram',  value: '@linhao_chinesee', href: TELEGRAM_URL },
                { label: 'WhatsApp',  value: '+7 777 612 8007',   href: WHATSAPP_URL },
                { label: 'Instagram', value: 'linhao.chinese',  href: INSTAGRAM_URL || '#' },
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          {/* Social icons */}
          <div className="flex items-center gap-4">
            <a href={TELEGRAM_URL} className="text-gray-400 hover:text-crimson transition-colors">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12L8.32 13.617l-2.96-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.828.942z"/>
              </svg>
            </a>
            <a href={INSTAGRAM_URL || '#'} className="text-gray-400 hover:text-crimson transition-colors">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
